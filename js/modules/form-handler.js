...
export class FormHandler {
  ...
  setupEventListeners() {
    ...
    // DB 검색은 CelebPickerRenderer에서 처리
  ...
  /**
   * DB 타입 변경 처리 - CelebPickerRenderer에서 처리하므로 비활성화
   */
  ...
  /**
   * DB 검색 처리 - CelebPickerRenderer에서 처리하므로 비활성화
   */
  ...
  /**
   * DB 검색 결과 렌더링 - CelebPickerRenderer에서 처리하므로 비활성화
   */
