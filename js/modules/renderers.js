...
export class BTIRenderer {
  ...
  render(result, hasTime, ohengData, yongsinData, daeunData, gender) {
    ...
    if (ilgan) {
      ...
      // 일간 개념 설명
      html += `<p class="bti-card-desc" style="color:var(--text-secondary);font-size:0.9rem;line-height:1.7;">일간(日干)은 사주의 네 기둥 중 '일주'의 천간으로, 나 자신을 대표하는 글자입니다. 사주 해석의 중심이 되며, 성격, 가치관, 행동 방식의 근본을 나타냅니다.</p>`;
      ...
      // 고유 개성 (카드 프레임 없이)
      if (ilgan.unique) {
        html += `<div style="margin-top:14px;"><span style="font-weight:600;color:var(--text);font-size:0.9rem;">${ilgan.name}만의 개성</span><p style="color:var(--text-secondary);font-size:0.9rem;line-height:1.7;margin:6px 0 0 0;">${ilgan.unique}</p></div>`;
      }

      // 고서 해석 (카드 프레임 없이)
      if (ilgan.classic) {
        html += `<div style="margin-top:14px;"><span style="font-weight:600;color:var(--text);font-size:0.9rem;">고서 해석</span><p style="color:var(--text-secondary);font-size:0.9rem;line-height:1.7;margin:6px 0 0 0;">${ilgan.classic}</p></div>`;
      }
    ...
    if (ilju) {
      ...
      // 일주 개념 설명
      html += `<p class="bti-card-desc" style="color:var(--text-secondary);font-size:0.9rem;line-height:1.7;">일주(日柱)는 태어난 날의 천간과 지지의 조합으로, 자신의 무의식적 성격과 내면을 나타냅니다. 배우자궁이기도 하여 대인관계와 결혼생활의 패턴을 보여줍니다.</p>`;

      html += `<p class="bti-card-desc">${ilju.personality}</p>`;

      // 일주 상세 정보 (카드 프레임 없이)
      if (ilju.strength || ilju.weakness) {
        html += `<div style="margin-top:14px;"><span style="font-weight:600;color:var(--text);font-size:0.9rem;">강점과 약점</span>`;
        if (ilju.strength) html += `<p style="color:var(--text-secondary);font-size:0.9rem;line-height:1.7;margin:6px 0 0 0;"><strong style="color:#2d8a4e;">강점:</strong> ${ilju.strength}</p>`;
        if (ilju.weakness) html += `<p style="color:var(--text-secondary);font-size:0.9rem;line-height:1.7;margin:6px 0 0 0;"><strong style="color:#c0392b;">약점:</strong> ${ilju.weakness}</p>`;
        html += `</div>`;
      }
      if (ilju.career) {
        html += `<div style="margin-top:14px;"><span style="font-weight:600;color:var(--text);font-size:0.9rem;">적합 직업</span>`;
        html += `<p style="color:var(--text-secondary);font-size:0.9rem;line-height:1.7;margin:6px 0 0 0;">${ilju.career}</p>`;
        html += `</div>`;
      }
      if (ilju.love) {
        html += `<div style="margin-top:14px;"><span style="font-weight:600;color:var(--text);font-size:0.9rem;">연애/결혼</span>`;
        html += `<p style="color:var(--text-secondary);font-size:0.9rem;line-height:1.7;margin:6px 0 0 0;">${ilju.love}</p>`;
        html += `</div>`;
      }
      if (ilju.tips) {
        html += `<div style="margin-top:14px;"><span style="font-weight:600;color:var(--text);font-size:0.9rem;">개운 TIP</span>`;
        html += `<p style="color:var(--text-secondary);font-size:0.9rem;line-height:1.7;margin:6px 0 0 0;">${ilju.tips}</p>`;
        html += `</div>`;
      }
      html += `</div>`;
    }
    ...
    if (wolju) {
      ...
      // 월주 개념 설명
      html += `<p class="bti-card-desc" style="color:var(--text-secondary);font-size:0.9rem;line-height:1.7;">월주(月柱)는 태어난 달의 천간과 지지의 조합으로, 의식적으로 발현되는 사회적 재능과 직업적 역량을 나타냅니다. 일주가 무의식적 성격이라면, 월주는 사회에서 의지적으로 발휘하는 능력입니다.</p>`;

      html += `<p class="bti-card-desc">${wolju.personality}</p>`;

      // 월주 상세 정보 (카드 프레임 없이)
      if (wolju.strength || wolju.weakness) {
        html += `<div style="margin-top:14px;"><span style="font-weight:600;color:var(--text);font-size:0.9rem;">사회적 강점과 약점</span>`;
        if (wolju.strength) html += `<p style="color:var(--text-secondary);font-size:0.9rem;line-height:1.7;margin:6px 0 0 0;"><strong style="color:#2d8a4e;">강점:</strong> ${wolju.strength}</p>`;
        if (wolju.weakness) html += `<p style="color:var(--text-secondary);font-size:0.9rem;line-height:1.7;margin:6px 0 0 0;"><strong style="color:#c0392b;">약점:</strong> ${wolju.weakness}</p>`;
        html += `</div>`;
      }
      if (wolju.career) {
        html += `<div style="margin-top:14px;"><span style="font-weight:600;color:var(--text);font-size:0.9rem;">적합 직업 (월주 기반)</span>`;
        html += `<p style="color:var(--text-secondary);font-size:0.9rem;line-height:1.7;margin:6px 0 0 0;">${wolju.career}</p>`;
        html += `</div>`;
      }
      html += `</div>`;
    }
    ...
    if (topGroupPct > 0) {
      ...
      if (mainSipsungInfo) {
        ...
        if (mainSipsungInfo.career1) {
          html += `<div style="margin-top:14px;"><span style="font-weight:600;color:var(--text);font-size:0.9rem;">적합 직업</span><p style="color:var(--text-secondary);font-size:0.9rem;line-height:1.7;margin:6px 0 0 0;">${mainSipsungInfo.career1}</p></div>`;
        }

        // 고서 해석 (카드 프레임 없이)
        if (mainSipsungInfo.classic) {
          html += `<div style="margin-top:14px;"><span style="font-weight:600;color:var(--text);font-size:0.9rem;">고서 해석</span><p style="color:var(--text-secondary);font-size:0.9rem;line-height:1.7;margin:6px 0 0 0;">${mainSipsungInfo.classic}</p></div>`;
        }
      }
      ...
      if (tsGroupSorted.length > 1 && tsGroupSorted[1][1] >= 15) {
        ...
        if (ts2Info) {
          ...
          // 적합 직업 (카드 프레임 없이)
          if (ts2Info.career1) {
            html += `<div style="margin-top:14px;"><span style="font-weight:600;color:var(--text);font-size:0.9rem;">적합 직업</span><p style="color:var(--text-secondary);font-size:0.9rem;line-height:1.7;margin:6px 0 0 0;">${ts2Info.career1}</p></div>`;
          }

          // 고서 해석 (카드 프레임 없이)
          if (ts2Info.classic) {
            html += `<div style="margin-top:14px;"><span style="font-weight:600;color:var(--text);font-size:0.9rem;">고서 해석</span><p style="color:var(--text-secondary);font-size:0.9rem;line-height:1.7;margin:6px 0 0 0;">${ts2Info.classic}</p></div>`;
          }
        }
      }
      html += `</div>`;
